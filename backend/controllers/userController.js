...
exports.resetPassword = catchAsyncErrors(async (req, res, next) => {
  //Getting the token from URL and finding user in database
  //Hashing token from req.params.token i.e URL
  ...
  //After password reset there will be no token or expiry keyword
  user.resetPasswordToken = undefined;
  user.resetPasswordExpire = undefined;
